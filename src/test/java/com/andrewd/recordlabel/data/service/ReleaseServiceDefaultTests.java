...
public class ReleaseServiceDefaultTests {
    ...
    public void getRelease_MustReturnSuperModel() {
        int entityId = 1;
        Release entity = new Release();
        com.andrewd.recordlabel.supermodels.Release expectedModel =
                new com.andrewd.recordlabel.supermodels.Release();

        Mockito.when(repository.getRelease(Matchers.eq(entityId))).thenReturn(entity);
        Mockito.when(entityTransformer.getRelease(Matchers.eq(entity))).thenReturn(expectedModel);

        // Run
        com.andrewd.recordlabel.supermodels.Release result = svc.getRelease(entityId);
    ...
    public void getRelease_MustReturnNullWhenNotFound() {
        ...
        // Run
        com.andrewd.recordlabel.supermodels.Release model = svc.getRelease(entityId);
    ...
    public void getReleaseSlim_MustReturnSuperModel() {
        int entityId = 1;
        Release entity = new Release();
        com.andrewd.recordlabel.supermodels.ReleaseSlim expectedModel =
                new com.andrewd.recordlabel.supermodels.ReleaseSlim();

        Mockito.when(repository.getRelease(Matchers.eq(entityId))).thenReturn(entity);
        Mockito.when(entityTransformer.getReleaseSlim(Matchers.eq(entity))).thenReturn(expectedModel);

        // Run
        com.andrewd.recordlabel.supermodels.ReleaseSlim result = svc.getReleaseSlim(entityId);
    ...
    public void getReleaseSlim_MustReturnNullWhenNotFound() {
        ...
        // Run
        com.andrewd.recordlabel.supermodels.ReleaseSlim model = svc.getReleaseSlim(entityId);
    ...
    public void getReleases_MustReturnAListOfSuperModels() {
        ...
        List<com.andrewd.recordlabel.supermodels.Release> superModels = new ArrayList<>();
        com.andrewd.recordlabel.supermodels.Release superModel1 = new com.andrewd.recordlabel.supermodels.Release();
        com.andrewd.recordlabel.supermodels.Release superModel2 = new com.andrewd.recordlabel.supermodels.Release();
    ...
    public void getMediaTypeList_MustReturnAListOfSuperModels() {
        ...
        List<com.andrewd.recordlabel.supermodels.MediaType> fake = new ArrayList<>();
        fake.add(new com.andrewd.recordlabel.supermodels.MediaType());
        ...
        // Run
        List<com.andrewd.recordlabel.supermodels.MediaType> result = svc.getMediaTypeList();
    ...
    public void getMetadataList_MustReturnAListOfSuperModels() {
        ...
        List<com.andrewd.recordlabel.supermodels.Metadata> fake = new ArrayList<>();
        fake.add(new com.andrewd.recordlabel.supermodels.Metadata());
        ...
        // Run
        List<com.andrewd.recordlabel.supermodels.Metadata> result = svc.getMetadataList();
    ...
    public void getArtistBarebonesList_MustListOfSuperModels() {
        ...
        List<com.andrewd.recordlabel.supermodels.ArtistBarebones> fake = new ArrayList<>();
        fake.add(new com.andrewd.recordlabel.supermodels.ArtistBarebones());
        ...
        // Run
        List<com.andrewd.recordlabel.supermodels.ArtistBarebones> result = svc.getArtistBarebonesList();
